...
// Provider logos as unit-box outlines, filled even-odd.
// From codenotch (https://github.com/vinzdg/codenotch), MIT License,
// Copyright (c) 2026 Vinz — see Vendor/CodenotchGlyphs/LICENSE.
// The logos themselves are trademarks of their owners.
enum GlyphOutline {
